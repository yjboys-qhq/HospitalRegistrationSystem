...
namespace WpfApp1
{
    ...
    public partial class bar : Page
    {
        ...
        private void init()
        {
            ...
            this.count = c.Count;
            CreateChartBar("挂号人数统计", LsTime, count);
        }

        #region 折线图
        public void CreateChartBar(string name, List<DateTime> lsTime, List<string> count)
        {
            //创建一个图标
            ...
            // 设置数据线的格式。         
            dataSeriesPineapple.RenderAs = RenderAs.Bar;
