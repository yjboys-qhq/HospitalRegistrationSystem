...
namespace WpfApp1
{
    ...
    /// point.xaml 的交互逻辑
    /// </summary>
    public partial class point : Page
    {
        public point()
        {
            InitializeComponent();
        ...
        private void init()
        {
            ...
            this.count = c.Count;
            CreateChartPoint("挂号人数统计", LsTime, count);
        }

        #region 折线图
        public void CreateChartPoint(string name, List<DateTime> lsTime, List<string> count)
        {
            //创建一个图标
            ...
            // 设置数据线的格式。         
            dataSeriesPineapple.RenderAs = RenderAs.Point;//折线图
