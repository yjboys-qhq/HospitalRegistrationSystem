...
namespace WpfApp1
{
    ...
    public partial class pie : Page
    {
        ...
        private void init()
        {
            ...
            this.count = c.Count;
            CreateChartPie("挂号人数统计", LsTime, count);
        }

        #region 折线图
        public void CreateChartPie(string name, List<DateTime> lsTime, List<string> count)
        {
            //创建一个图标
            ...
            // 设置数据线的格式。         
            dataSeriesPineapple.RenderAs = RenderAs.Pie;
